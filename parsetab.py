...
_lr_productions = [
  ...
  ('program -> classes','program',1,'p_program','new_parser.py',25),
  ('classes -> class','classes',1,'p_classes','new_parser.py',30),
  ('classes -> class classes','classes',2,'p_classes','new_parser.py',31),
  ('class -> CLASS TYPE inheritance LBRACE features_opt RBRACE SEMICOLON','class',7,'p_class','new_parser.py',41),
  ('inheritance -> INHERITS TYPE','inheritance',2,'p_inheritance','new_parser.py',46),
  ('inheritance -> empty','inheritance',1,'p_inheritance','new_parser.py',47),
  ('features_opt -> features','features_opt',1,'p_features_opt','new_parser.py',57),
  ('features_opt -> empty','features_opt',1,'p_features_opt','new_parser.py',58),
  ('features -> feature','features',1,'p_features','new_parser.py',65),
  ('features -> feature features','features',2,'p_features','new_parser.py',66),
  ('feature -> ID LPAREN formals_opt RPAREN COLON TYPE LBRACE expr RBRACE SEMICOLON','feature',10,'p_feature','new_parser.py',75),
  ('feature -> attr_def SEMICOLON','feature',2,'p_feature','new_parser.py',76),
  ('attr_defs -> attr_def','attr_defs',1,'p_attr_defs','new_parser.py',85),
  ('attr_defs -> attr_def COMMA attr_defs','attr_defs',3,'p_attr_defs','new_parser.py',86),
  ('attr_def -> ID COLON TYPE assign_opt','attr_def',4,'p_attr_def','new_parser.py',95),
  ('assign_opt -> assign','assign_opt',1,'p_assign_opt','new_parser.py',99),
  ('assign_opt -> empty','assign_opt',1,'p_assign_opt','new_parser.py',100),
  ('assign -> ASSIGN expr','assign',2,'p_assign','new_parser.py',104),
  ('formals_opt -> formals','formals_opt',1,'p_formals_opt','new_parser.py',108),
  ('formals_opt -> empty','formals_opt',1,'p_formals_opt','new_parser.py',109),
  ('formals -> formal','formals',1,'p_formals','new_parser.py',116),
  ('formals -> formal COMMA formals','formals',3,'p_formals','new_parser.py',117),
  ('formal -> ID COLON TYPE','formal',3,'p_formal','new_parser.py',126),
  ('params_opt -> params','params_opt',1,'p_params_opt','new_parser.py',130),
  ('params_opt -> empty','params_opt',1,'p_params_opt','new_parser.py',131),
  ('params -> expr','params',1,'p_params','new_parser.py',138),
  ('params -> expr COMMA params','params',3,'p_params','new_parser.py',139),
  ('block -> blockelements','block',1,'p_block','new_parser.py',148),
  ('blockelements -> expr SEMICOLON','blockelements',2,'p_blockelements','new_parser.py',152),
  ('blockelements -> expr SEMICOLON blockelements','blockelements',3,'p_blockelements','new_parser.py',153),
  ('typeactions -> typeaction','typeactions',1,'p_typeactions','new_parser.py',162),
  ('typeactions -> typeaction typeactions','typeactions',2,'p_typeactions','new_parser.py',163),
  ('typeaction -> ID COLON TYPE ACTION expr SEMICOLON','typeaction',6,'p_typeaction','new_parser.py',172),
  ('function_call -> ID LPAREN params_opt RPAREN','function_call',4,'p_function_call','new_parser.py',176),
  ('targettype_opt -> targettype','targettype_opt',1,'p_targettype_opt','new_parser.py',181),
  ('targettype_opt -> empty','targettype_opt',1,'p_targettype_opt','new_parser.py',182),
  ('targettype -> AT TYPE','targettype',2,'p_targettype','new_parser.py',186),
  ('expr -> SELF','expr',1,'p_expr_self','new_parser.py',190),
  ('expr -> ID assign','expr',2,'p_expr','new_parser.py',194),
  ('expr -> expr targettype_opt DOT function_call','expr',4,'p_expr','new_parser.py',195),
  ('expr -> function_call','expr',1,'p_expr','new_parser.py',196),
  ('expr -> IF expr THEN expr ELSE expr FI','expr',7,'p_expr','new_parser.py',197),
  ('expr -> WHILE expr LOOP expr POOL','expr',5,'p_expr','new_parser.py',198),
  ('expr -> LET attr_defs IN expr','expr',4,'p_expr','new_parser.py',199),
  ('expr -> CASE expr OF typeactions ESAC','expr',5,'p_expr','new_parser.py',200),
  ('expr -> NEW TYPE','expr',2,'p_expr','new_parser.py',201),
  ('expr -> INT_COMP expr','expr',2,'p_expr','new_parser.py',202),
  ('expr -> NOT expr','expr',2,'p_expr','new_parser.py',203),
  ('expr -> ISVOID expr','expr',2,'p_expr','new_parser.py',204),
  ('expr -> expr PLUS expr','expr',3,'p_expr','new_parser.py',205),
  ('expr -> expr MINUS expr','expr',3,'p_expr','new_parser.py',206),
  ('expr -> expr MULTIPLY expr','expr',3,'p_expr','new_parser.py',207),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr','new_parser.py',208),
  ('expr -> expr LT expr','expr',3,'p_expr','new_parser.py',209),
  ('expr -> expr LTEQ expr','expr',3,'p_expr','new_parser.py',210),
  ('expr -> expr EQ expr','expr',3,'p_expr','new_parser.py',211),
  ('expr -> LBRACE block RBRACE','expr',3,'p_expr','new_parser.py',212),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_expr','new_parser.py',213),
  ('expr -> ID','expr',1,'p_expr','new_parser.py',214),
  ('expr -> INTEGER','expr',1,'p_expr','new_parser.py',215),
  ('expr -> STRING','expr',1,'p_expr','new_parser.py',216),
  ('expr -> BOOL','expr',1,'p_expr','new_parser.py',217),
  ('empty -> <empty>','empty',0,'p_empty','new_parser.py',253),
]
